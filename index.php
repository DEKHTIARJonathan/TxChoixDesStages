        ...
        <div class="container">
            <div id="wrap">
                    ...
                    <?php
                    	...
                    	{
                    		echo '<div class="alert alert-danger" style="width:780px; height:80px;">';
                    		echo '<div style="margin-top:15px">Pour pouvoir réaliser des voeux, vous devez vous authentifier.</div>';
						...
						{
							echo '<div class="alert alert-success" style="width:780px; height:80px;">';
                    		echo "<div style='margin-top:15px'>Bienvenue <b>".$_SESSION["auth"]["login_utc"]."</b> sur l'interface de réalisation de voeux pour les stages TN09 & TN10</div>";
